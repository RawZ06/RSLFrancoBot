 ...
 */
@Component
public class SaladMixButtonHandler {

    private final SeedService seedService;
    private final SeedPresenter presenter;

    public SaladMixButtonHandler(SeedService seedService, SeedPresenter presenter) {
    ...
    public void handle(DiscordInteraction interaction) {
        try {
            ...
            interaction.sendChannelMessage(presenter.presentSeedResult(result, "Mix en folie", interaction.getUsername()));
