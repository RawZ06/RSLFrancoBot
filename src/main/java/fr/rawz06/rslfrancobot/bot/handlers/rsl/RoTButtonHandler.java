 ...
 */
@Component
public class RoTButtonHandler {

    private final SeedService seedService;
    private final SeedPresenter presenter;

    public RoTButtonHandler(SeedService seedService, SeedPresenter presenter) {
    ...
    public void handle(DiscordInteraction interaction) {
        try {
            ...
            interaction.sendChannelMessage(presenter.presentSeedResult(result, "RoT", interaction.getUsername()));
